...
```vb
Public Sub Start(Optional ByVal PortOrSerial As String = "")
```
...
```vb
Event OnReadRequest(ByVal ClientID As String, ByVal FunctionCode As ModbusFunctionCode, ByVal Address As Long, ByVal Quantity As Long)
```
...
```vb
Private Sub mbSlave_OnReadRequest(ByVal ClientID As String, ByVal FunctionCode As ModbusFunctionCode, ByVal Address As Long, ByVal Quantity As Long)
...
```vb
Event OnWriteRequest(ByVal ClientID As String, ByVal FunctionCode As ModbusFunctionCode, ByVal Address As Long, ByRef Data As Variant)
```
...
```vb
Private Sub mbSlave_OnWriteRequest(ByVal ClientID As String, ByVal FunctionCode As ModbusFunctionCode, ByVal Address As Long, ByRef Data As Variant)
